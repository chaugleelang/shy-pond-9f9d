...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shy-pond-9f9d
```

A live public deployment of this template is available at [https://shy-pond-9f9d.templates.workers.dev](https://shy-pond-9f9d.templates.workers.dev)
